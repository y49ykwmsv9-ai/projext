...
export function createWorldState(date='1936-01-01',seed=19360101):WorldState{
 return {date,tick:0,playerNation:undefined,nations:{},mapEntities:{},units:{},treaties:{},events:[],news:[],political:{identities:{},borderHistory:[],mapRevision:0},seed,economy:{},military:{},diplomacy:{},scenario:{presetId:'sandbox',presetDate:date,branchId:'branch-'+seed+'-'+Math.random().toString(36).slice(2,8),divergence:0,historyLog:[],historicalTrackers:{},lastAdvanceDays:0}};
}
