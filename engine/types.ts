...
export interface NewsItem{id:EntityId;date:DateKey;title:string;summary:string;category:'political'|'diplomatic'|'economic'|'military'|'social'|'historical';importance:number;relatedNation?:EntityId;relatedEvent?:EntityId;mentionedNations?:EntityId[];read?:boolean;source:'player'|'ai'|'system'|'historical';}
