...
export default function WorldMap({worldState,mapMode,admin1Features,cityFeatures,historicalFeatures,selectedNationId,selectedRegion,zoom,onCountrySelect,onRegionSelect,onZoomChange}:Props){
 ...
 useEffect(()=>{
  ...
  try{
   map=new maplibregl.Map({container:el.current,style:LOCAL_MAP_STYLE,center:[0,20],zoom:1.05,minZoom:0,maxZoom:18,renderWorldCopies:false,dragRotate:false,pitchWithRotate:false,maxPitch:0,antialias:false,attributionControl:false,fadeDuration:0,refreshExpired:false});
  }catch{
