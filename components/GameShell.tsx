...
export default function GameShell(){
 ...
 return <main className='game-shell'>
  ...
  <div className='floating map-hint'>Pinch / scroll to zoom · drag to pan · tap a country or region</div><div className='floating map-modes'><span>MAP</span>{(['political','economy','military','resources'] as const).map(m=><button className={mapMode===m?'active':''} onClick={()=>setMapMode(m)} key={m}>{m}</button>)}</div>
