...
export default function GameShell(){
 ...
 function selectCountry(id:string,name:string){const live=worldState.nations[id];const n=live?makeNation(id,live.name):makeNation(id,name);setWorldState(s=>({...s,playerNation:id}));setSelected(n);setSelectedRegion(null);setTab('Overview');setShowMenu(true)}
