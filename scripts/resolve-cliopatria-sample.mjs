...
const wanted=[
 {key:'visigothic-kingdom',candidates:['Visigothic Kingdom','Visigoths']},
 {key:'al-andalus',candidates:['Al-Andalus','Al Andalus']},
 {key:'asturias',candidates:['Asturias']}
];
const references=wanted.map(x=>{
 const f=find(711,x.candidates);
 return {key:x.key,source:'Cliopatria',resolved:Boolean(f),record:f?f.properties:null,geometry:f?.geometry||null};
});
const result={dataset:'Cliopatria',version,year:711,sourceUrl:'https://github.com/Seshat-Global-History-Databank/cliopatria/tree/'+version,recordCount:features.length,references,geographicPoints:[
